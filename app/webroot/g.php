...
$no_thumb            = 'plugin/noimg.png';  // show this when no thumbnail exists 
$extensions          = array("jpg","png","gif","JPG","PNG","GIF"); // allowed extensions in photo gallery 
$itemsPerPage        = '4';    // number of images per page if not already specified in ajax mode 
$thumb_width         = '320';   // width of thumbnails in pixels
